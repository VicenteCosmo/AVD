  ...
  return (
          ...
          {filtered.map(course => (
            <TableRow key={course.id}>
              <TableCell  onClick={()=> {setCursoselcionado(course) 
                setabrir(true)}} className="cursor-pointer underline">{course.course_name}</TableCell>
              <TableCell>{formatDate(course.course_init_date)}</TableCell>
              <TableCell>{formatDate(course.course_finish_date)}</TableCell>
    ...
    <Dialog open={abrir} onOpenChange={setabrir}>
      <DialogTrigger asChild> 
          ...
          <DialogTitle>{cursoseleciodado?.course_name}</DialogTitle>
          <DialogDescription>{cursoseleciodado?.course_description}</DialogDescription>
            <p><strong>Instrutor:</strong>{cursoseleciodado?.course_instructors}</p>
            <p><strong>Requisitos:</strong>{cursoseleciodado?.course_requirements}</p>
            <p>{}</p>
            <p>{}</p>
            </div>
