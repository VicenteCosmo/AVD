...
export default function Section1(){
    ...
    return(
        <div className="  w-full h-120 bg-[#27282c] p-5 " >
            <div className=" justify-center mx-auto flex md:flex-row sm:flex-col align-content-center " >

                <div className=" py-5 w-1/2  " >
                    <h1 className="text-white sm:flex-col text-5xl font-bold bg-gradient-to-r from-[#3ffc2f] to-[#2f83c3] bg-clip-text text-transparent " >
                ...
                <div className="my-10 md:py-4 md:block " >
